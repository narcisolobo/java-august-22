                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form:form action="/users/register" method="POST" modelAttribute="user">
                            ...
                            <div class="mb-3">
                                <form:label class="form-label" path="profilePic">Upload Profile Picture</form:label>
                                <form:input class="form-control" type="file" path="profilePic" />
                                <form:errors class="form-text text-danger" path="profilePic" />
                            </div>
                            <div class="mb-3">
