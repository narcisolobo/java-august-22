...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="card">
                    <h5 class="card-header">Edit a Laker</h5>
                    <div class="card-body">
                        <form:form action="/lakers/${laker.id}/update" method="POST" modelAttribute="laker">
                            ...
                            <div class="d-flex justify-content-end">
                                <input type="submit" value="EDIT Laker" class="btn btn-primary">
                            </div>
                        </form:form>
                    </div>
                </div>
